...
for subject in part_list:
    ...
    for func_data_counter, func_data in enumerate(func_data_list):
        ...
        nib.save(nib.Nifti1Image(difference_aroma_uncleaned, affine = func_data.affine, header = func_data.header), BASEPATH + '{0}/glms/TSNR_difference_aroma_to_uncleaned_{1}.nii.gz'.format(sub_id, space_identifier))
        ...
        nib.save(nib.Nifti2Image(difference_aroma_retro_uncleaned, affine = func_data.affine, header = func_data.header), BASEPATH + '{0}/glms/TSNR_difference_aromaretro_to_uncleaned_{1}.nii.gz'.format(sub_id, space_identifier))
        ...
        nib.save(nib.Nifti2Image(percent_unique_tsnr_retro_to_aroma, affine=func_data.affine, header=func_data.header),
                 BASEPATH + '{0}/glms/TSNR_difference_unique_percent_retro_to_aroma_{1}.nii.gz'.format(sub_id,space_identifier))
        ...
        nib.save(nib.Nifti2Image(percent_unique_tsnr_aroma_to_retro, affine=func_data.affine, header=func_data.header),
                 BASEPATH + '{0}/glms/TSNR_difference_percent_unqiue_aroma_to_retro_{1}.nii.gz'.format(sub_id, space_identifier))
        ...
        nib.save(nib.Nifti2Image(percent_unique_tsnr_acompcor_to_aroma, affine=func_data.affine, header=func_data.header),
                 BASEPATH + '{0}/glms/TSNR_difference_unique_percent_acompcor_to_aroma_{1}.nii.gz'.format(sub_id,space_identifier))
        ...
        nib.save(nib.Nifti2Image(percent_unique_tsnr_retro_to_aroma_acompcor, affine=func_data.affine, header=func_data.header),
                 BASEPATH + '{0}/glms/TSNR_difference_unique_percent_retro_to_aroma_acompcor_{1}.nii.gz'.format(sub_id,space_identifier))               
        ...
        nib.save(nib.Nifti2Image(percent_retro_uncleaned, affine=func_data.affine, header=func_data.header),
                 BASEPATH + '{0}/glms/TSNR_percent_retro_uncleaned_{1}.nii.gz'.format(sub_id, space_identifier))
        ...
        nib.save(nib.Nifti2Image(percent_aroma_uncleaned, affine=func_data.affine, header=func_data.header),
                 BASEPATH + '{0}/glms/TSNR_percent_aroma_uncleaned_{1}.nii.gz'.format(sub_id, space_identifier))
        ...
        nib.save(nib.Nifti2Image(percent_acompcor_uncleaned, affine=func_data.affine, header=func_data.header),
                 BASEPATH + '{0}/glms/TSNR_percent_acompcor_uncleaned_{1}.nii.gz'.format(sub_id, space_identifier))        
    ...
    output_list_names = ['tsnr_noclean_MNI', 'tsnr_retro_MNI', 'tsnr_aroma_MNI', 'tsnr_acompcor_MNI', 'tsnr_aroma_retro_MNI', 'tsnr_aroma_acompcor_MNI', 
                           'tsnr_aroma_retro_acompcor_MNI', 'tsnr_unique_aroma_to_retro_MNI', 'tsnr_unique_acomppcor_to_aroma_MNI','tsnr_unique_retro_to_aroma_acompcor_MNI',
                           'tsnr_difference_aroma_uncleaned_MNI',
                           'tsnr_difference_aroma_retro_uncleaned_MNI', 'tsnr_difference_retro_uncleaned_MNI',
                           'tsnr_percent_retro_uncleaned_MNI',
