...
participant_map = glob.glob(BASEPATH + f'{sub_id}/glm_output/glm5_retro_aroma'
                             '/unique_retro_z_score_bonferroni_corrected.nii.gz')[0]
...
zmap_data_binarised_inverted = nib.load(participant_map).get_fdata()
...
nib.save(zmap_nii, sub_id + '_binarised.nii.gz')
